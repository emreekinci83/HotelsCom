...
public class JavaScriptUtil {
	...
	public static String getElementById(WebDriver driver, String id ){
		String script =  "return document.getElementById('"+ id +"').value;";
		JavascriptExecutor js = ((JavascriptExecutor) driver);
		return (String) js.executeScript(script);
	}
	public static String getElementByClass(WebDriver driver, String className ){
		String script =  "return document.getElementById('"+ className +"').value;";
		JavascriptExecutor js = ((JavascriptExecutor) driver);
		return (String) js.executeScript(script);
	}
